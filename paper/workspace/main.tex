...
\newpage
\section{Method Invariant Minimization}

The method Invariant Minimization constructs an invariant \verb=I= that uses a minimal number places for given Petri net \verb=N= and \verb=P= when \verb=N= never violates \verb=P=.
We present the method Invariant Minimization by example on a simplified mutual exclusion algorithm by Delzanno2001.
...
\begin{center}
  \begin{tabular}{ | p{7cm} | r | r | r | r | } %
    ...
    Invariant \& Invariant Minimization    & 23 &  0 & 54 &  0 \\
...
\begin{center}
  \begin{tabular}{ | p{6cm} | r | r | r | r | }
    ...
    Invariant \& Invariant Minimization    & 14 &  0 & 13 &  0 \\
...
\begin{center}
  \begin{tabular}{ | p{6cm} | r | r | r | r | }
    ...
    Invariant \& Invariant Minimization    & 2 & 0 & 26 & 0 \\
...
We constructed the following two invariants by applying the method Invariant Minimization.
