...
transition(t3, [x1, x7, x9, (x10, 5)], [x7, (x10, 5), x2, x3]).
transition(t4, [x2, x4, x6], [x1, x9]).
transition(t5, [(x5, 5)], [(x6, 5)]).
transition(t6, [x3], [x4, x5]).
transition(t7, [x8, (x10, 5), (x12, 10)], [(x12, 10), x7]).
transition(t8, [x7, (x13, 2)], [(x13, 2), x8, (x10, 5)]).
transition(t9, [x9, x10, x13, x15], [x9, x11, x12, x16]).
transition(t10, [x9, x10, x13, x14], [x9, x11, x12, x16]).
transition(t11, [x7, x9, (x12, 9), x21], [x7, x9, (x12, 5), (x13, 4), x20]).
...
transition(t16, [(x12, 5), x20], [(x12, 5), x14, (x15, 3), x17]).
transition(t17, [(x13, 6), x20], [(x13, 4), (x12, 2), x14, x15, x18]).
