...
transition(t2, [l0, s0], [l2]).
transition(t3, [l0, s0], [l17]).
transition(t4, [l0, s0], [l18]).
...
transition(t12, [l1, s7], [l3]).
transition(t13, [l2, s7], [l6]).
transition(t14, [l3, s7], [s8, l4]).
transition(t15, [l4, s7], [s9, l1]).
transition(t16, [l5, s7], [s10, l2]).
transition(t17, [l6, s7], [s11, l5]).
transition(t18, [l7, s7], [l8]).
transition(t19, [l8, s7], [l10]).
transition(t20, [l9, s7], [l8]).
transition(t21, [l10, s7], [l7]).
transition(t22, [l10, s7], [l9]).
transition(t23, [l10, s7], [l11]).
transition(t24, [l10, s7], [l12]).
transition(t25, [l11, s7], [l8]).
transition(t26, [l11, s7], [s12, l14]).
transition(t27, [l12, s7], [l8]).
transition(t28, [l12, s7], [s15, l15]).
transition(t29, [l14, s7], [s13, l8]).
transition(t30, [l15, s7], [s14, l8]).
transition(t31, [l17, s7], [l13]).
transition(t32, [l18, s7], [l16]).
